...
import tim.huang.kcw.sample.viewmodel.FetchState
import tim.huang.kcw.sample.viewmodel.FetchViewModel
import tim.huang.kcw.sample.viewmodel.UploadState
...
fun App() {
    MaterialTheme {
        ...
        KoinApplication(application = {
            loadKoinModules(tim.huang.kcw.sample.di.shareModule)
        }){
            DemoApp()
        }
    }
